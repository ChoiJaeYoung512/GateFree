...
path = '/home/krri/Desktop/data/col_4/0721/test1/'
...
# MAP 불러오기
mapPath = ['/home/krri/Desktop/data/col_4/0713/0713_map.csv',
           '/home/krri/Desktop/data/col_4/0718/0718_map.csv',
           '/home/krri/Desktop/data/col_4/0720/0720_map.csv',
           '/home/krri/Desktop/data/col_4/0721/0721_map.csv']
...
map1 = (map2_data + map3_data + map4_data)/3    # 0609 외 나머지3개 맵 데이터 평균
map2 = (map1_data + map3_data + map4_data)/3    # 0612 외 나머지3개 맵 데이터 평균
map3 = (map1_data + map2_data + map4_data)/3    # 0613 외 나머지3개 맵 데이터 평균
map4 = (map1_data + map2_data + map3_data)/3    # 0616 외 나머지3개 맵 데이터 평균
...
for d, tm in zip(df_list, target_minor):
    data_list.append(Dist(d, tm, map4, ms))
    print(Dist(d, tm, map4, ms))
