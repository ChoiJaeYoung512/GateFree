...
mapPath = ['/home/krri/Desktop/gatefree/GF/data/col_4/0718/0718_map.csv',
           '/home/krri/Desktop/gatefree/GF/data/col_4/0720/0720_map.csv',
           '/home/krri/Desktop/gatefree/GF/data/col_4/0721/0721_map.csv',
           '/home/krri/Desktop/gatefree/GF/data/col_4/0801/0801_map.csv']
...
# folder_name = ['0713','0718','0720','0721']
...
for a, folder_name in enumerate(folder_name, 1) :
    ...
    map4 = (map1_data + map2_data + map3_data )/3

    ms = 5
    data_list = []
    map_data_list = [map1, map2, map3, map4]
...
# 파일 저장
    ...
    sfile = f'avg_{a}_4D_100ms.csv'
    # sfile = f'avg_{a}_100ms.csv'
