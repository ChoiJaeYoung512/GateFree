...
# map1 = (map2_data + map3_data + map4_data )/3  
# map2 = (map1_data + map3_data + map4_data )/3  
# map3 = (map1_data + map2_data + map4_data )/3  
# map4 = (map1_data + map2_data + map3_data )/3
map1 = (map2_data + map3_data + map4_data + map5_data)/4  
map2 = (map1_data + map3_data + map4_data + map5_data)/4  
map3 = (map1_data + map2_data + map4_data + map5_data)/4  
...
for a, folder_name in enumerate(folder_name, 1) :
    ...
    for i in range(len(df_list)):
        result = Dist(df_list[i], target_minor[i], map_df, tier_lists[i])
    ...
    sfile = f'avgTier_s_{a}_5D_20ms.csv'
