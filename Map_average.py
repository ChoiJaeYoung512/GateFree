...
path = '/home/krri/Desktop/gatefree/GF/data/col_4/0713/test1/'
...
mapPath = ['/home/krri/Desktop/gatefree/GF/data/col_4/0713/',
           ...
           '/home/krri/Desktop/gatefree/GF/data/col_4/0801/']

mapFile = ['0713_map.csv', '0718_map.csv', '0720_map.csv', '0721_map.csv','0801_map.csv']

# map 평균내서 구하기
map1_data = pd.read_csv(os.path.join(mapPath[0], mapFile[0]), index_col=0)
map2_data = pd.read_csv(os.path.join(mapPath[1], mapFile[1]), index_col=0)
map3_data = pd.read_csv(os.path.join(mapPath[2], mapFile[2]), index_col=0)
map4_data = pd.read_csv(os.path.join(mapPath[3], mapFile[3]), index_col=0)
map5_data = pd.read_csv(os.path.join(mapPath[4], mapFile[4]), index_col=0)
...
for d, tm in zip(df_list, target_minor):
    data_list.append(Dist(d, tm, map1, ms))
    print(Dist(d, tm, map1, ms))
    
# 파일 저장
savePath = '/home/krri/Desktop/data/col_4/avgMap/'
sfile = 'test.csv'
# sfile = 'avg_s_4_100ms.csv'
